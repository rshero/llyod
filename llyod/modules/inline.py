    ...
    for ihelp in inline_help_dicts:
        results.append(
            await event.builder.article(
                ...
                thumb=InputWebDocument(ihelp["thumb_urL"], size=50, mime_type='image/jpeg', attributes=[]),
                buttons=Button.switch_inline(text="Click Here",query=ihelp["keyboard"], same_peer=True),
            )
        )
    await event.answer(results, cache_time=5, switch_pm="More Options?", switch_pm_param="help")
